...
def _impl(repository_ctx):
    paths = resolve_labels(repository_ctx, [
        ...
        "@rules_arm_clang//arm_clang:toolchain.bzl",
        "@rules_arm_clang//arm_clang:config.bzl.tpl",
        "@rules_arm_clang//arm_clang:gen.bzl.tpl",
    ])

    repository_ctx.symlink(paths["@rules_arm_clang//arm_clang:toolchain.bzl"], "toolchain.bzl")
    ...
    optional_cflags = []
    armclang_ver_py = repository_ctx.path(Label("@rules_arm_clang//:armclang_version.py"))
    ...
    repository_ctx.template(
        "config.bzl",
        paths["@rules_arm_clang//arm_clang:config.bzl.tpl"],
        {
    ...
    repository_ctx.template(
        "gen.bzl",
        paths["@rules_arm_clang//arm_clang:gen.bzl.tpl"],
        {"%{armclang_root_path}": armclang_path},
    )
